leafletSearchDependencies <- function() {
  list(
    htmltools::htmlDependency(
      "lfx-search", version = "2.3.7",
      src = system.file("htmlwidgets/lfx-search", package = "leaflet.extras2"),
      script = c("lfx-search-prod.js",
                 "lfx-search-bindings.js"),
      stylesheet = c("lfx-search-prod.css"),
      all_files = TRUE
    )
  )
}
